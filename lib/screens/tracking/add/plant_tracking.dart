                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              onPressed: () async {
                                if (_displayDiseaseTextField == false) {
                                  setState(() {
                              ...
                              icon: _displayDiseaseTextField == false
                                  ...
                                  : Image.asset("images/delete-button.png"),
                              //color: Colors.green,
                              iconSize: 32,
                            ),
                          ],
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              onPressed: () async {
                                if (_displayInsectTextField == false) {
                                  setState(() {
                        ...
                        Visibility(
                          ...
                          child: Column(
                            children: [
                              MyForm()
                                  .buildformNum("น้ำหนัก (kg) : ", _ctlWeight),
                              const SizedBox(height: 20),
                              buildTrashLogTime(),
                              const SizedBox(height: 20),
                              MyForm().buildform(
                              ...
                              const SizedBox(height: 20),
                              MyForm()
                                  .buildform("** หมายเหตุ : ", _ctlTrashRemark),
                              const SizedBox(height: 30),
                            ],
                          ),
                        ),
